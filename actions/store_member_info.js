module.exports = {
	...
	<div>
		<div style="padding-top: 8px; width: 70%;">
			...
			<select id="info" class="round">
				...
				<option value="23">Member Nitro Boost Date</option>
				<option value="24">Member Nitro Boost Timestamp</option>
	...
	action: function(cache) {
		...
		switch(info) {
			...
			case 12:
				if(mem.user) {
					result = mem.user.displayAvatarURL({format:"png",size:"2048"});
				}
				break;
			case 13:
				if(mem.roles) {
			...
			case 21:
				...
				break;
			case 22:
				if (mem.presence.activities.emoji) {
					result = mem.presence.activities.emoji;
				} else {
					result = "";
				}
				if (mem.presence.game && mem.presence.activities.type == "CUSTOM_STATUS") {
					result += mem.presence.activities.state;
				}
				break;
			case 23:
				result = mem.premiumSince;
				break;
			case 24:
				result = mem.premiumSinceTimestamp;
				break;
			default:
				break;
		}
