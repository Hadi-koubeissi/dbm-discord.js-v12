module.exports = {
	...
	const info = ['Game Application ID', 'Game Details', 'Game Name', 'Game State', 'Easter Egg', 'Game Stream URL', 'Game Status Type', 'Game Large Image ID', 'Game Large Image URL', 'Game Large Image Text', 'Game Small Image ID', 'Game Small 	Image URL', 'Game Small Image Text', 'Game Timestamp Start', 'Game Party ID', 'Game Timestamp End', 'Game Party Size'];
	...
	action: function(cache) {
		...
		let result;
		if (!mem.presence.activities) {
			result = "null";
		} else {
			switch(info) {
				case 0:
					result = mem.presence.activities.applicationID;
					break;
				case 1:
					result = mem.presence.activities.details;
					break;
				case 2:
		    		result = mem.presence.activities.name;
					break;
				case 3:
					result = mem.presence.activities.state;
					break;
				case 5:
		    		result = mem.presence.activities.url;
					break;
				case 6:
		    		result = mem.presence.activities.type;
					break;
				case 7:
		    		if (!mem.presence.activities.assets) {
			    		result = "null";
					} else {
						result = mem.presence.activities.assets.largeImage;
					}
					break;
				case 8:
		    		if (!mem.presence.activities.assets) {
						...
						result = mem.presence.activities.assets.largeImageURL;
					}
					break;
				case 9:
		    		if (!mem.presence.activities.assets) {
				...
				case 10:
		    		if (!mem.presence.activities.assets) {
						...
						result = mem.presence.activities.assets.smallImage;
					}
					break;
				case 11:
		    		if (!mem.presence.activities.assets) {
				...
				case 12:
		    		if (!mem.presence.activities.assets) {
						...
						result = mem.presence.activities.assets.smallText;
					}
					break;
				case 13:
		    		if (!mem.presence.activities.timestamps) {
			    		result = "null";
					} else {
						result = mem.presence.activities.timestamps.start;
					}
					break;
				case 14:
		    		if (!mem.presence.activities.party) {
			    		result = "null";
					} else {
						result = mem.presence.activities.party.id;
					}
					break;
				case 15:
		    		if (!mem.presence.activities.timestamps) {
						...
						result = mem.presence.activities.timestamps.end;
					}
					break;
				case 16:
		    		if (!mem.presence.activities.party) {
						...
						result = mem.presence.activities.party.size;
					}
					break;
			}
		}
