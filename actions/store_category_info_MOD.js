	...
	action: function(cache) {
		...
		switch(info) {
			...
			case 5:
				...
				break;
			case 6:
				result = targetCategory.children.array();
				break;
			case 7:
				result = targetCategory.children.size;
				break;
			case 8:
				result = targetCategory.children.filter(c => c.type == "text").array();
				break;
			case 9:
				result = targetCategory.children.filter(c => c.type == "text").size;
				break;
			case 10:
				result = targetCategory.children.filter(c => c.type == "voice").array();
				break;
			case 11:
				result = targetCategory.children.filter(c => c.type == "voice").size;
				break;
			default:
				break;
		}
