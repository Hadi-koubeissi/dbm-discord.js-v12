module.exports = {
	...
	action: function(cache) {
		...
		var spotifyApi = new SpotifyWebApi({ clientId: cclientid, clientSecret: cclientsecret});

		spotifyApi.clientCredentialsGrant().then(() => {
			spotifyApi.setAccessToken(data.body['access_token']);

			if(searchtype === 0) {
				spotifyApi.searchTracks(value, { limit : results}).then(data => {
					switch(info1) {
						case 0:
							result = data.body.tracks.items[results2].name;
							break;
						case 1:
							result = data.body.tracks.items[results2].artists.map(a => a.name);
							break;
						case 2:
							result = data.body.tracks.items[results2].artists.map(a => a.id);
							break;
						case 3:
							result = data.body.tracks.items[results2].album.name;
							break;
						case 4:
							result = data.body.tracks.items[results2].album.id;
							break;
						case 5:
							result = data.body.tracks.items[results2].id;
							break;
						case 6:
							result = data.body.tracks.items[results2].external_urls.spotify;
							break;
						case 7:
							result = data.body.tracks.items[results2].available_markets;
							break;
						case 8:
							result = data.body.tracks.items[results2].duration_ms;
							break;
						case 9:
							result = data.body.tracks.items[results2].popularity;
							break;
						case 10:
							result = data.body.tracks.items[results2].explicit;
							break;
						case 11:
							result = data.body.tracks.items[results2].is_local;
							break;
						case 12:
							result = data.body.tracks.total;
							break;
						case 13:
							result = data;
							break;
				...
				spotifyApi.searchArtists(value, { limit : results}).then(data => {
					switch(info2) {
						case 0:
							result = data.body.artists.items[results2].name;
							break;
						case 1:
							result = data.body.artists.items[results2].id;
							break;
						case 2:
							result = data.body.artists.items[results2].external_urls.spotify;
							break;
						case 3:
							result = data.body.artists.items[results2].followers.total;
							break;
						case 4:
							result = data.body.artists.items[results2].genres;
							break;
						case 5:
							result = data.body.artists.items[results2].popularity;
							break;
						case 6:
							result = data.body.artists.items[results2].images[0].url;
							break;
						case 7:
							result = data.body.artists.items[results2].images[1].url;
							break;
						case 8:
							result = data.body.artists.items[results2].images[2].url;
							break;
						case 9:
							result = data.body.artists.total;
							break;
						case 10:
							result = data;
							break;
				...
				spotifyApi.searchPlaylists(value, { limit : results}).then(data => {
					switch(info3) {
						case 0:
							result = data.body.playlists.items[results2].name;
							break;
						case 1:
							result = data.body.playlists.items[results2].id;
							break;
						case 2:
							result = data.body.playlists.items[results2].external_urls.spotify;
							break;
						case 3:
							result = data.body.playlists.items[results2].owner.display_name;
							break;
						case 4:
							result = data.body.playlists.items[results2].owner.id;
							break;
						case 5:
							result = data.body.playlists.items[results2].owner.external_urls.spotify;
							break;
						case 6:
							result = data.body.playlists.items[results2].snapshot_id;
							break;
						case 7:
							result = data.body.playlists.items[results2].tracks.total;
							break;
						case 8:
							result = data.body.playlists.items[results2].images[0].url;
							break;
						case 9:
							result = data.body.playlists.items[results2].images[1].url;
							break;
						case 10:
							result = data.body.playlists.items[results2].images[2].url;
							break;
						case 11:
							result = data.body.playlists.items[results2].collaborative;
							break;
						case 12:
							result = data.body.playlists.total;
							break;
						case 13:
							result = data;
							break;
				...
				spotifyApi.searchAlbums(value, { limit : results}).then(data => {
					switch(info4) {
						case 0:
							result = data.body.albums.items[results2].name;
							break;
						case 1:
							result = data.body.albums.items[results2].artists.map(a => a.name);
							break;
						case 2:
							result = data.body.albums.items[results2].artists.map(a => a.id);
							break;
						case 3:
							result = data.body.albums.items[results2].id;
							break;
						case 4:
							result = data.body.albums.items[results2].release_date;
							break;
						case 5:
							result = data.body.albums.items[results2].album_type;
							break;
						case 6:
							result = data.body.albums.items[results2].external_urls.spotify;
							break;
						case 7:
							result = data.body.albums.items[results2].total_tracks;
							break;
						case 8:
							result = data.body.albums.items[results2].available_markets;
							break;
						case 9:
							result = data.body.albums.items[results2].images[0].url;
							break;
						case 10:
							result = data.body.albums.items[results2].images[1].url;
							break;
						case 11:
							result = data.body.albums.items[results2].images[2].url;
							break;
						case 12:
							result = data.body.albums.total;
							break;
						case 13:
							result = data;
							break;
